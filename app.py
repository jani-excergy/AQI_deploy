...
def main():
    ...
    Average_Temperature= st.text_input("Average_Temperature (°C)  "," ")
    Maximum_Temperature = st.text_input("Maximum_Temperature  (°C) "," ")
    Minimum_Temperature = st.text_input("Minimum_Temperature  (°C) "," ")
    Atm_pressure_at_sea_level = st.text_input("Atm_pressure_at_sea_level (hPa) "," ")
    Average_wind_speed = st.text_input("Average_wind_speed  (Km/h) "," ")
    result=""
